...
public class ThreadWithSyncAccess {
	...
	public static void main(String[] args) {
		...
		ExecutorService poolOfThread = Executors.newFixedThreadPool(7);// creating thread pool
	 ...
	 * accessed one at a time. made synchronized so one thread can access at a time.
	 * 
	 */
