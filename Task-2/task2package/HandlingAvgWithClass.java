...
public class HandlingAvgWithClass {
	// made this variable static in-order to make changes in same variable and to
	// use inside static methods
...
class RangeException extends Exception {
	// created Exception classes to throw exception for out of range either less
